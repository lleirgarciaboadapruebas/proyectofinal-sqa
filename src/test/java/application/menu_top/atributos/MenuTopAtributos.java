package application.menu_top.atributos;

/**
 * Created by lleir on 25/6/17.
 */
public class MenuTopAtributos {

    public final String liFacturaId = "factura";
    ...
    public final String labelTextoEncabezadoFacturas = "Listado Facturas";
